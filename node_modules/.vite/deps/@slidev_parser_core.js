...
// node_modules/@slidev/parser/dist/chunk-3UOELSP3.mjs
...
var isObject2 = (val) => toString2(val) === "[object Object]";
...
${data.content.trim()}
`;
  data.raw = Object.keys(data.frontmatter || {}).length ? data.frontmatterStyle === "yaml" ? `\`\`\`yaml
...
function safeParseYAML(str2) {
  const res = js_yaml_default.load(str2);
  return isObject2(res) ? res : {};
}
